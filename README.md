...
- 🎯 **相似内容直达结果（v1.3）**：识别后服务器**直接抓取并页内展示真实网址**——相似图片（DuckDuckGo/Openverse/百度图片）、**相关视频（真实 B站/抖音/YouTube 链接含时长）**、文章网页（必应解码）、百科词条（维基百科），全部免密钥公开接口，按 相似图片/相关视频/文章网页/百科词条 分组，一键复制到引用报告
